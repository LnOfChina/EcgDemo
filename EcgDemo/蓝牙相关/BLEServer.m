...
- (void)peripheral:(CBPeripheral *)peripheral didDiscoverServices:(NSError *)error
{
    if (nil == error) {
        ...
        for (CBService *service in peripheral.services) {
            if ([service.UUID.UUIDString isEqualToString:@"ffb1"]||[service.UUID.UUIDString isEqualToString:@"FFB1"]||[service.UUID.UUIDString isEqualToString:@"0000ffb1-0000-1000-8000-00805f9b34fb"]||[service.UUID.UUIDString isEqualToString:@"0000FFB1-0000-1000-8000-00805F9B34FB"]) {
                [self discoverService:service];
//                break;
            }
        }
...
- (void)peripheral:(CBPeripheral *)peripheral didDiscoverCharacteristicsForService:(CBService *)service error:(NSError *)error
{
    if (nil == error) {
        ...
        NSLog(@"---发现的特征值%@",service.characteristics);
       

        if ([(id)self.delegate respondsToSelector:@selector(didFoundEcgCheck)]) {
            [self.delegate didFoundEcgCheck];
        }
